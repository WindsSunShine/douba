...
- (void)didClickRegistButtonItemAction:(UIBarButtonItem *)buttonItem
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:self.registView.usernameView.inputFieldText forKey:@"username"];
    [[NSUserDefaults standardUserDefaults]setObject:self.registView.passwordView.inputFieldText forKey:@"password"];
    // userdefaults同步synchronize
